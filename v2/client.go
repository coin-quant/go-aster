...
import (
	...
	"github.com/coin-quant/go-aster/v2/delivery"
	"github.com/coin-quant/go-aster/v2/futures"
	"github.com/coin-quant/go-aster/v2/options"
)
...
func NewFuturesClient(user, signer, privKeyHex string) *futures.Client {
	return futures.NewClient(user, signer, privKeyHex)
}
